#
# Module manifest for module 'PSBoxCLI'
#
# Generated by: Hal Sclater
#
# Generated on: 21/07/2020
#

<# 
Box PowerShell wrapper module using the Box CLI
Makes the Box CLI easier to use within PowerShell
Requires the Box CLI installed and configured as per https://developer.box.com/guides/tooling/sdks/cli/
Check the CLI documentation here for all possible BoxCLI commands and add to this file as required https://github.com/box/boxcli 
#>
...
GUID = '6ad96f5e-e4b0-4790-b64c-e1e8a0d77824'
...
Description = 'PowerShell wrapper module for BoxCLI'
